...
class SmoothToolTipAnim: public Animate<SmoothToolTip> 
{ 
  Q_OBJECT 
 public:SmoothToolTipAnim(SmoothToolTip& src):Animate(src){} 
};
...
{ 
	...
	friend  class Animate<SmoothToolTip>;
	...
	protected:
		...
		inline void updateCurrentTime(int currentTime);
	...
	private:
		...
		// animation:
		SmoothToolTipAnim   m_scrollAnimation;
