...
class TaskbarLayout : public QAbstractAnimation,  public QGraphicsLayout {
	Q_OBJECT
	...
	Q_PROPERTY(qreal duration READ duration WRITE setExpandDuration)
	...
	public:
		...
		int  duration() const { return m_expandDuration; }
	...
	private:
		void updateCurrentTime(int current_time);
