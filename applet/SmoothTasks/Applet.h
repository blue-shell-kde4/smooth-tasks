...
class MyGroupManager : public TaskManager::GroupManager
{
public :
  MyGroupManager(Plasma::Applet *parent):GroupManager(parent){}
  KConfigGroup config() const  { KConfigGroup cg = ((Plasma::Applet*)(parent()))->config(); qDebug()<< "Config"<<cg.name(); return cg;}
};
...
private:
	...
	MyGroupManager           *m_groupManager;
        TaskManager::TaskGroup              *m_rootGroup; 
