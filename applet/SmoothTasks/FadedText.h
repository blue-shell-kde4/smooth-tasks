...
class FadedText : public QWidget {
	...
	friend  class Animate<FadedText>;
	typedef Animate<FadedText> FadedTextAnim;
...
private:
	...
	FadedTextAnim   m_scrollAnimation;
        qreal     m_step;
	qreal       m_animLeft;
